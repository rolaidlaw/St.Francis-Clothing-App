...
public class AdminMaintainProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.product_name2);
        price = findViewById(R.id.product_price2);
        description = findViewById(R.id.product_description2);
    ...
    private void deleteThisProduct() {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                startActivity(new Intent(AdminMaintainProducts.this, AdminCategory.class));
                finish();
